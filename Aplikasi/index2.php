                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta">
                                <a href="#" data-toggle="tooltip" data-placement="bottom" title="anekaindahnursery@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> <span>Email: anekaindahnursery@gmail.com</span></a>
                                <a href="#" data-toggle="tooltip" data-placement="bottom" title="+6281234567890"><i class="fa fa-phone" aria-hidden="true"></i> <span>Call Us: +6281234567890</span></a>
                            </div>
                            ...
                            <div class="top-header-meta d-flex">
                                ...
                                <!-- Cart -->
                                <div class="cart">
                                    <a href="cart.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Cart <span class="cart-quantity"></span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="alazeaNav">
                        ...
                        <!-- Nav Brand -->
                        <a href="index.html" class="nav-brand"><img src="img/core-img/LogoTH.png" alt=""></a>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center">
                                ...
                                <p>KAMI MENAWARKAN BERBAGAI MACAM JENIS TANAMAN HIAS YANG DAPAT MENGHIASI RUMAH, LINGKUNGAN SEKOLAH, GEDUNG DLL.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2>KAMI MELAYANI DENGAN SETULUS HATI</h2>
                                <p>KAMI MENAWARKAN BERBAGAI MACAM JENIS TANAMAN HIAS YANG DAPAT MENGHIASI RUMAH, LINGKUNGAN SEKOLAH, GEDUNG DLL.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget">
                            <div class="footer-logo mb-30">
                                <a href="#"><img src="img/core-img/LogoTH.png" alt=""></a>
                            </div>
                            <p>TEMUI KAMI DI SOSIAL MEDIA KAMI</p>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget">
                            ...
                            <div class="contact-information">
                                <p><span>Alamat:</span> Jl. Sorong - Aimas, Klablim, Sorong Tim., Kota Sorong, Papua Bar. 98414</p>
                                <p><span>Telepon:</span> +6281234567890</p>
                                <p><span>Email:</span> anekanursery@gmail.com</p>
                                <p><span>Jam Buka:</span> Senin - Sabtu: 08.00 - 22.00 WIT</p>
                                <p><span>Jam Buka:</span> Minggu: 10.00 - 22.00 WIT</p>
                            </div>
                        </div>
                    </div>
                </div>
