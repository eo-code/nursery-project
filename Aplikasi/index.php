                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta d-flex">
                                <!-- Login -->
                                <div class="login">
                                    <a href="Login/index.php"><i class="fa fa-user" aria-hidden="true"></i> <span>Login</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(img/bg-img/0.jpg);"></div>
