...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Data Tanaman Hias</h3>
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah Tanaman</button>
<br/>
<br/>
...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-4">Nama Tanaman Hias</th>
